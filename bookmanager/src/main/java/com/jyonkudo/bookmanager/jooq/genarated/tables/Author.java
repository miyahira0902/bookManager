...
public class Author extends TableImpl<AuthorRecord> {
    ...
    /**
     * The reference instance of <code>book_manager.author</code>
     */
    ...
    /**
     * The column <code>book_manager.author.id</code>. 著者ID
     */
    public final TableField<AuthorRecord, Integer> ID = createField(DSL.name("id"), SQLDataType.INTEGER.nullable(false).identity(true), this, "著者ID");

    /**
     * The column <code>book_manager.author.name</code>. 著者名
     */
    public final TableField<AuthorRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(255).nullable(false), this, "著者名");

    /**
     * The column <code>book_manager.author.birth_date</code>. 生年月日
     */
    public final TableField<AuthorRecord, LocalDate> BIRTH_DATE = createField(DSL.name("birth_date"), SQLDataType.LOCALDATE.nullable(false), this, "生年月日");
    ...
    private Author(Name alias, Table<AuthorRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment("著者テーブル"), TableOptions.table(), where);
    }

    /**
     * Create an aliased <code>book_manager.author</code> table reference
     */
    ...
    /**
     * Create a <code>book_manager.author</code> table reference
     */
    public Author() {
    ...
    public BookAuthorPath bookAuthor() {
        if (_bookAuthor == null)
            _bookAuthor = new BookAuthorPath(this, null, Keys.BOOK_AUTHOR_IBFK_2.getInverseKey());
     ...
     * <code>book_manager.book</code> table
     */
