...
import com.jyonkudo.bookmanager.jooq.genarated.Indexes;
...
import com.jyonkudo.bookmanager.jooq.genarated.tables.Book.BookPath;
...
public class BookAuthor extends TableImpl<BookAuthorRecord> {
    ...
    /**
     * The reference instance of <code>book_manager.book_author</code>
     */
    ...
    /**
     * The column <code>book_manager.book_author.book_id</code>. 書籍ID
     */
    public final TableField<BookAuthorRecord, Integer> BOOK_ID = createField(DSL.name("book_id"), SQLDataType.INTEGER.nullable(false), this, "書籍ID");

    /**
     * The column <code>book_manager.book_author.author_id</code>. 著者ID
     */
    public final TableField<BookAuthorRecord, Integer> AUTHOR_ID = createField(DSL.name("author_id"), SQLDataType.INTEGER.nullable(false), this, "著者ID");
    ...
    private BookAuthor(Name alias, Table<BookAuthorRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment("書籍・著者関連テーブル"), TableOptions.table(), where);
    }

    /**
     * Create an aliased <code>book_manager.book_author</code> table reference
     */
    ...
    /**
     * Create a <code>book_manager.book_author</code> table reference
     */
    public BookAuthor() {
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.BOOK_AUTHOR_AUTHOR_ID);
    }
    ...
    public List<ForeignKey<BookAuthorRecord, ?>> getReferences() {
        return Arrays.asList(Keys.BOOK_AUTHOR_IBFK_1, Keys.BOOK_AUTHOR_IBFK_2);
    }

    private transient BookPath _book;

    /**
     * Get the implicit join path to the <code>book_manager.book</code> table.
     */
    public BookPath book() {
        if (_book == null)
            _book = new BookPath(this, Keys.BOOK_AUTHOR_IBFK_1, null);
    ...
    /**
     * Get the implicit join path to the <code>book_manager.author</code> table.
     */
    public AuthorPath author() {
        if (_author == null)
            _author = new AuthorPath(this, Keys.BOOK_AUTHOR_IBFK_2, null);
